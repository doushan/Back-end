...
namespace ProductsApp.Controllers
{
    public class StaffController : ApiController
    {
        Staff[] _staff  = new Staff[]
        {
            ...
            new Staff{Id = 1, FirstName = "Bonie", LastName = "Coder", Username = "bbb", Password = "555", ConfirmPassword = "555", PhoneNumber = "78963254", ResidenceNumber = "7896325", Email = "bonie@live.com", Address = "Quatre Borne", JobTitle = "Developer"}
        ...
        {
            var staff = _staff.FirstOrDefault((p) => p.Id == id);
            if (_staff == null)
            {
                return NotFound();
            }
